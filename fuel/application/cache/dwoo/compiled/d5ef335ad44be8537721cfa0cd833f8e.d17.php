...
<html lang="en-US">
        ...
        <div class="conten">
            ...
            <header class="hader">
                <div class="hader_text">
                    <div class="hader_logo"><img src="<div id="error_php" style="width: 500px; margin: auto; border: 1px solid #ddd; padding: 20px;">
	...
	<p>Severity: Notice</p>
	<p>Message:  Undefined variable: assets_path</p>
	<p>Filename: core/Loader.php(332) : eval()'d code</p>
	<p>Line Number: 32</p>

</div>images/logo.png" height="93" width="189" alt="logo" /></div>
